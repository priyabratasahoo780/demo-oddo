        ...
        <header className="h-16 flex items-center justify-between px-8 bg-white border-b border-gray-100 sticky top-0 z-30">
            ...
            <div className="relative w-[380px]">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-14 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-[13px] text-gray-600 placeholder-gray-400 outline-none focus:border-[#C99A3D]/50 focus:ring-1 focus:ring-[#C99A3D]/20 transition-all cursor-pointer"
                />
